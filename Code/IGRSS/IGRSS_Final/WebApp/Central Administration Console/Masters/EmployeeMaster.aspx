<%@ Page Title="" Language="C#" MasterPageFile="~/IGRSS_Default.master" AutoEventWireup="true" CodeFile="EmployeeMaster.aspx.cs" Inherits="Central_Administration_Console_Masters_EmployeeMaster" %>
...
<h1 style="text-align: center" align="center">EMPLOYEE MASTER</h1>
    <table width="100%">
        <tr>    
        ...
        <asp:View ID="view2_Fv" runat="server">
            <center>
            <h1 align="center">EMPLOYEE MASTER</h1>
             </center>
